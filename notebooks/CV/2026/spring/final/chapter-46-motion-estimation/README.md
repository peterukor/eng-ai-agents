...
The notebook includes a linked reference section near the beginning with the content figures used in MIT Vision Book Chapter 46.
...
Chapter 46 should be read as a combination of linked MIT reference figures for context and the executable notebook outputs plus regenerated `images/` files for the reproduced implementation results.
